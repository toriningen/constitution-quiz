    ...
    base.methods = {
      ...
      answerQuestion: function(answerEl) {
        ...
        if (selected === correct) {
          ...
          $('.answers a[data-index="'+correct+'"]').addClass('correct');
      ...
      updateCounter: function() {
        var countStr = base.options.counterFormat.replace('%current', Math.min(currentQuestion, numQuestions)).replace('%total', numQuestions).replace('%score', score);
